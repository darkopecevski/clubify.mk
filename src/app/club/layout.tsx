...
const navigation = [
  ...
  { name: "Teams", href: "/club/teams", icon: Users },
  { name: "Players", href: "/club/players", icon: UserSquare2 },
  { name: "Coaches", href: "/club/coaches", icon: Users },
  { name: "Matches", href: "/club/matches", icon: Trophy },
  { name: "Training", href: "/club/training", icon: Calendar },
  { name: "Payments", href: "/club/payments", icon: DollarSign },
