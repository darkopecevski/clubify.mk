...
export default function TrainingDetailsClient({
  ...
  const handleUpdateSession = async () => {
    if (!editFormData.session_date || !editFormData.start_time || !editFormData.end_time) {
    ...
    const [startHours, startMinutes] = editFormData.start_time.split(":").map(Number);
    const [endHours, endMinutes] = editFormData.end_time.split(":").map(Number);
    ...
    try {
      ...
      setErrorMessage("Failed to update session. Please try again.");
    } finally {
  ...
  return (
    <>
          ...
          {editingNotes ? (
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-8 text-center dark:border-gray-700 dark:bg-gray-900/50">
              <p className="text-sm text-gray-500 dark:text-gray-400">
                No training notes added yet. Click &quot;Edit Notes&quot; to add your observations
      ...
      {showCancelConfirm && sessionToDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-lg border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="mt-3 rounded-lg bg-gray-50 p-3 dark:bg-gray-700">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {formatDate(sessionToDelete.session_date)} at {formatTime(sessionToDelete.start_time)}
              </p>
            </div>
